...
class TestAuditMiddlewareEmitsEvent:
    ...
    def test_emits_event_on_delete(
        self, client: TestClient, memory_sink: MemorySink
    ) -> None:
    ...
    def test_skips_excluded_paths(
        ...
        assert response.status_code == 200
        assert len(memory_sink.events) == 0
...
class TestMultipleRequests:
    ...
    def test_emits_separate_events(
        self, client: TestClient, memory_sink: MemorySink
    ) -> None:
        ...
        assert len(memory_sink.events) == 3
